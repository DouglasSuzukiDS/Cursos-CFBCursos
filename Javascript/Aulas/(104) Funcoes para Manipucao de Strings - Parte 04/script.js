...
// ------ Novos metodos
console.log(nome.startsWith('s')) // Verifica se a string começa com o termo
console.log(nome.endsWith('s')) // Verifica se a string termina com o termo

console.log(nome.includes('n')) // Verifica se a string contem o termo

console.log(nome.repeat(4))
 
console.log(nome.charCodeAt(0)) // Retorna o codigo
...
console.log(String.fromCodePoint(83, 104, 97, 110, 107, 115)) // Retorna o caractere pelo codigo