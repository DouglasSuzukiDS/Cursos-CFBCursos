...
CREATE TABLE `tipoproduto` (
  `n_tipoproduto_tipoproduto` int NOT NULL AUTO_INCREMENT,
  `s_desc_tipoproduto` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`n_tipoproduto_tipoproduto`)
...
INSERT INTO `tipoproduto` VALUES (1,'Eletônicos'),(2,'Alimentação'),(3,'Vestuário');
...
-- Dump completed on 2023-08-04 23:00:23
