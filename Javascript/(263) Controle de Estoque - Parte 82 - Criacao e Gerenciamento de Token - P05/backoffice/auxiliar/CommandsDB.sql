...
UPDATE pessoa SET n_priacess_pessoa = 0 WHERE n_pessoa_pessoa = 1;
UPDATE pessoa SET n_priacess_pessoa = 1 WHERE n_pessoa_pessoa = 5;
UPDATE pessoa SET s_senha_pessoa = '' WHERE n_pessoa_pessoa = 5;
UPDATE pessoa SET s_senha_pessoa = 123 WHERE n_pessoa_pessoa = 6;

SELECT * FROM token;
DELETE FROM token WHERE n_token_token != 1;
ALTER TABLE token AUTO_INCREMENT = 2;
