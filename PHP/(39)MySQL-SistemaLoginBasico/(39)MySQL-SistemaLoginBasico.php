...
<head>
    <meta charset="UTF-8">
    <title>CFB Cursos - PHP 39 - MySQL - Sistema de Login Básico</title>
</head>
...
<body>
    ...
    <?php
        ...
        if($linha > 0){
            ...
            setcookie("numLogin", $num); //Cria um Cookie, (nome,numero);
            header("Location:aula39B.php?num1=$num"); //Chama outra página, passando o valor de num;
        }else{
            echo "ERRO no Login<br>";
            echo "<a href='formAula39.html'>Voltar</a>";
        }
