...
class Aula23{
    static void Main(){
        ...
        //Caso não encontre o elemento, retorna -1
        ...
        //Copia o Array e insere em outro;
        ...
        //Copia o Array, e insere no outro Array, apartir da posição;
        ...
        //Retorna o MENOR indice do Array
        ...
        int MaiiorIndiceMatriz_D1 = matriz.GetUpperBound(1);
        Console.WriteLine("Maior índice do vetor1 {0}", MaiiorIndiceMatriz_D1);
        Console.WriteLine("----------------------------------------");

        //public object GetValue(long índice);
        //Retorna a posição apartir de um indice
        ...
        //Retorna a PRIMEIRA Posição do elemento Encontrado
        ...
        //Retorna a ÚLTIMA Posição do elemento Encontrado
        Console.WriteLine("LastIndexOf");
        int indice2 = Array.LastIndexOf(vetor1, 3);
        Console.WriteLine("Indice do valor valor 33: {0}", indice2);
        Console.WriteLine("----------------------------------------");
