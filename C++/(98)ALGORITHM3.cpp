...
int main (){
	...
	//replace_if = Substitui valores da coleção que atenda, a determinada condição
	...
	//is_sort = Verifica se a coleção esta ordenada
	cout << "IS_SORTED" << endl;
	...
	vector<int>vt13(10);
	merge(vt11.begin(),vt11.end(),vt12.begin(),vt12.end(),vt13.begin());
	for(auto x:vt10){
        cout << x << "  ";
	}
	...
	//set_intersection = Interseção de duas coleções(elementos comuns)
	...
	vector<int>vt19(7);
	set_intersection(vt17.begin(),vt17.end(),vt18.begin(),vt18.end(),vt19.begin());
	for(auto x:vt19){
        cout << x << "  ";
	}
    ...
    //min e max = Retorna os menores e os maiores valores
    cout << "MIN e MAX" << endl;
    int n1,n2;
    n1=10;
    n2=5;
    ...
    //mimmax = Retorna os menores e maiores valores dentre vários
    cout << "MINMAX" << endl;
    ...
    cout << "MIN_ELEMENTE, MAX_ELEMENT, MINMAX_ELEMENT" << endl;
