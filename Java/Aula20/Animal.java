// Aula 20 - Exercicio Classes - Parte 01
...
abstract class Animal implements SerVivo {
   ...
   public void atacar(Animal a) {
      if (this.vivo) {
         ...
         System.out.println("---------------");
         System.out.println(this.getClass().toGenericString() + " est morto, e nao pode atacar");
         System.out.println("---------------");
      }
   }
   ...
   public void mover() {
      if (this.vivo) {
         ...
         System.out.println("---------------");
         System.out.println(this.getClass().toGenericString() + " est morto, e nao pode mover");
         System.out.println("---------------");
      }
   }
   ...
   public void comer(int massa) {
      if (this.vivo) {
         ...
         System.out.println("---------------");
         System.out.println(this.getClass().toGenericString() + " est morto, e nao pode comer");
         System.out.println("---------------");
      }
   }
